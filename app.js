...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('ICream.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('ICream.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('ICream.xml', function(err, result) {
      ...
      delete result.catalogue.section[obj.section].entree[obj.entree];
